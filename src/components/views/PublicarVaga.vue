    ...
    salvarVaga() {
      ...
      if (this.validarFormulario()) {
        ...
        this.emitter.emit("alerta", {
          ...
          descricao:
            "Parabéns, a vaga foi cadastrada e pode ser consultada por milhares de profissionais em nossa plataforma",
        });
        ...
        this.emitter.emit("alerta", {
          tipo: "erro",
          titulo: `Oopssss... Não foi possível realizar o cadastro`,
